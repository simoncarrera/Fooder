<div class="container-v3 " id="container__post-recipe">
  <form id="form" method="post" action="" class="form" enctype="multipart/form-data">
    ...
    <div class="form__container--content <?php echo (isset($errormessage_title)) ? "fail" : "success"; ?>">
      ...
      <textarea id="title" class="form__container--textarea-title form-control" name="title" maxlength="75"></textarea>
    ...
    <div class="form__container--content <?php echo (isset($errormessage_intro)) ? "fail" : "success"; ?>">
      ...
      <textarea id="intro" class="form__container--textarea-introduction form-control" name="introduction" maxlength="250"></textarea>
    ...
    <div class="form__container--content <?php echo (isset($errormessage_ingredients)) ? "fail" : "success"; ?>">
      ...
      <textarea id="ingredients" class="form__container--textarea-ingredients form-control" name="ingredients" maxlength="500"></textarea>
    ...
    <div class="form__container--content <?php echo (isset($errormessage_steps)) ? "fail" : "success"; ?>">
      ...
      <textarea id="steps" class="form__container--textarea-steps form-control" name="steps" maxlength="2000"></textarea>
    ...
    <div class="text-end">
      ...
      <button type="submit" id="publish" class="btn btn-warning  form__container--post ">Publicar</button>
    </div>
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">¿Seguro que quiere descartar la publicación?</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            Si descarta la publicación no se va a poder recuperar los datos ingresados
          </div>
