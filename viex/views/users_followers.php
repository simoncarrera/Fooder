<div class="container-v5 d-grid grid-template-rows">
  ...
  <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-around">
    <a href="../web/users_followers.php?id=<?php echo $_GET['id'] ?>" aria-selected="true">Seguidores</a>
    <a href="../web/users_followeds.php?id=<?php echo $_GET['id'] ?>" aria-selected="false">Seguidos</a>
  </div>
</div>
